...
plot_bar(phyloseq_obj, fill = "Kingdom") +
  ggtitle("Distribution of abundant Kingdom in each sample") +
  theme(legend.position = "bottom")
```

```{r Order}
plot_bar(phyloseq_obj, fill = "Phylum") +
  ggtitle("Distribution of abundant Phylum in each sample") +
  theme(legend.position = "bottom")
```

```{r Order}
plot_bar(phyloseq_obj, fill = "Class") +
  ggtitle("Distribution of abundant Class in each sample") +
  theme(legend.position = "bottom")
```

```{r Order}
plot_bar(phyloseq_obj, fill = "Order") +
  ggtitle("Distribution of abundant Order in each sample")
```
